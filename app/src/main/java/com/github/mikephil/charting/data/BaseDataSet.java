...
/**
 * Created by Philipp Jahoda on 21/10/15. This is the base dataset of all
 * DataSets. It's purpose is to implement critical methods provided by the
 * IDataSet interface.
 */
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
	...
	/**
	 * List representing all colors that are used for drawing the actual values
	 * for this DataSet
	 */
	...
	/**
	 * Use this method to tell the data set that the underlying data has
	 * changed.
	 */
	 ...
	 * Sets the colors that should be used fore this DataSet. Colors are reused
	 * as soon as the number of Entries the DataSet represents is higher than
	 * the size of the colors array. You can use "new int[] { R.color.red,
	 * R.color.green, ... }" to provide colors for this method. Internally, the
